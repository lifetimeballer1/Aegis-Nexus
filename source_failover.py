...
QUARANTINE={'France 24':{'status':'replaced','replacement':'RFI World','replacementUrl':'https://www.rfi.fr/en/general/rss','note':'France 24 /en/rss serves HTML, not RSS (verified 2026-09-09); catalog now polls RFI World instead.'},'CNN Topstories RSS':{'status':'unavailable','note':'http://rss.cnn.com/rss/cnn_topstories.rss returns HTTP 200 but serves stale 2024 cache (lastBuildDate Aug 2024, verified 2026-09-11); not added.'},'ReliefWeb Updates RSS':{'status':'unavailable','note':'https://reliefweb.int/updates/rss.xml answers 406 bot-block (verified 2026-09-11); UN News Global added instead for humanitarian coverage.'},'AP Top News RSS':{'status':'unavailable','note':'https://apnews.com/rss answers 403 Cloudflare challenge (verified 2026-09-11); no working no-key path.'},'SOUTHCOM Direct RSS':{'status':'unavailable','note':'southcom.mil ArticleCS RSS returns HTTP 200 empty octet-stream body (verified 2026-09-11); DoD News Releases added instead; GDELT southcom.mil mirror retained.'},'RFI Americas RSS':{'status':'unavailable','note':'https://www.rfi.fr/en/americas/rss redirects to /en/international/rss (verified 2026-09-11); duplicate of RFI World family, not added.'},'X @NASA':{'status':'unavailable','note':'X proxy challenge/whitelist; no working no-key RSS proxy known (verified 2026-09-09).'},'X @WhiteHouse':{'status':'unavailable','note':'X proxy challenge/whitelist; no working no-key RSS proxy known (verified 2026-09-09).'},'X @POTUS':{'status':'unavailable','note':'X proxy challenge/whitelist; no working no-key RSS proxy known (verified 2026-09-09).'},'X @NATO':{'status':'unavailable','note':'X proxy challenge/whitelist; no working no-key RSS proxy known (verified 2026-09-09).'},'X @UN':{'status':'unavailable','note':'X proxy challenge/whitelist; no working no-key RSS proxy known (verified 2026-09-09).'}}
